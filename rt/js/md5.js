...
// MD5 DIGEST                                                                //
//                                                                           //
// derivated from a function found at                                        //
// http://www.javascriptfr.com/codes/FONCTION-MD5_41808.aspx                 //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
...
#define xx(q,a,b,x,s,ac) add(rol(add(add(a, q), add(x, ac)), s),b)
#define ff(a,b,c,d,x,s,ac) xx((b & c) | ((~b) & d), a, b, x, s, ac)
#define gg(a,b,c,d,x,s,ac) xx((b & d) | (c & (~d)), a, b, x, s, ac)
#define hh(a,b,c,d,x,s,ac) xx(b ^ c ^ d, a, b, x, s, ac)
#define ii(a,b,c,d,x,s,ac) xx(c ^ (b | (~d)), a, b, x, s, ac)
