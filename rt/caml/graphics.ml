...
external open_graph: int -> int -> Js.Node.t = "caml_gr_open_graph"
external close_graph: unit -> unit = "caml_gr_close_graph"
...
external raw_draw_arc : int -> int -> int -> int -> int -> int -> unit = "caml_gr_draw_arc" "caml_gr_draw_arc_nat"
...
external raw_fill_arc : int -> int -> int -> int -> int -> int -> unit = "caml_gr_fill_arc" "caml_gr_fill_arc_nat"
