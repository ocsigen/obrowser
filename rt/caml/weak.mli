...
(** Warning: Weak pointers are not implemented in O'Browser.
    This module is has the same interface as the usual Weak module,
    but without weak pointers ... If you use it, this will probably
    result in a leak of memory. 
*)
